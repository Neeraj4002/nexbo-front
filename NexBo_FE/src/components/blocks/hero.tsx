      ...
      >
        ...
        >
          <div className="flex flex-col items-center text-center space-y-4">
            <h1
              className={cn(
                "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight bg-gradient-to-r from-gray-200 via-white to-gray-200 bg-clip-text text-transparent",
                titleClassName,
              )}
            >
              {title}
                ...
                {actions.map((action, index) => (
                  <ShimmerButton
                    ...
                    background={action.variant === "default" 
                      ? "linear-gradient(110deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.05))" 
                      : "transparent"}
